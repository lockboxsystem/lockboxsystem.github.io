define({ api: [
  {
    ...
    "error": {
      "fields": {
        "Es konnte kein Kunde gefunden werden.": [
          {
            "group": "CustomerNotFound",
            "field": "anchor_nr_empty",
            "optional": false,
            "description": "<p>Missing anchor number.</p>"
          },
          {
            "group": "CustomerNotFound",
            "field": "anchor_nr_incorrect",
            "optional": false,
            "description": "<p>Anchor number not found.</p>"
          },
          {
            "group": "CustomerNotFound",
            "field": "anchor_nr_wrong",
            "optional": false,
            "description": "<p>No customer found.</p>"
          }
        ],
        "Error 4xx": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "reference",
            "optional": false,
            "description": "<p>Referenz Nummer aus dem eigenen System. Auch als String möglich. Wird auf dem Label abgebildet wenn vorhanden.</p>"
          },
          {
            "group": "Parameter",
            "type": "Object[]",
          ...
          },
          {
            ...
            "field": "date_start",
            "optional": true,
            "description": "<p>Ob welchem Datum die Sendung abgeholt werden kann. Dies erlaubt es Sendungen in der Zukunft zu erstellen um das Label im internen Prozess zu verwenden. In der Form Y-m-d.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "description": "<p>Liefert eine Liste von Sendungen zurück die dem ServiceProvider zugewiesen sind oder erstellt wurden. Die Ausgabe ist auf maximal 100 Sendungen beschränkt.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "field": "filter",
            "optional": true,
            "description": "<p>Filtert das Ergebniss vor. Mögliche Werte sind nodriver, deliver, failure, sent, tour, pickup</p>"
          }
        ]
      }
    },
